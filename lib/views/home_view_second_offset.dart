...
class HomeSecondoffset extends StatefulWidget {
  HomeSecondoffset({Key? key}) : super(key: key) {
    imageCache.clear();
  ...
  @override
  State<HomeSecondoffset> createState() => _HomeScreenState();
}

class _HomeScreenState extends State<HomeSecondoffset>
  ...
  void initState() {
    super.initState();
    characterRepository = CharacterRepository(this, '99');
