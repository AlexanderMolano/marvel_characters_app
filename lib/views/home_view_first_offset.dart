...
class HomeFirstoffset extends StatefulWidget {
  HomeFirstoffset({Key? key}) : super(key: key) {
    imageCache.clear();
  ...
  @override
  State<HomeFirstoffset> createState() => _HomeScreenState();
}

class _HomeScreenState extends State<HomeFirstoffset>
